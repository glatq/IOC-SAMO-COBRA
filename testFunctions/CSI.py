...
class CSI:
    def __init__(self):
        self.lower = np.array([0.5, 0.45, 0.5, 0.5, 0.875, 0.4, 0.4])
        self.upper = np.array([1.5, 1.35, 1.5, 1.5, 2.625, 1.2, 1.2])
        self.nConstraints = 10
        self.nObj = 3
        self.ref = np.array([42, 4.5, 13])
        self.nadir = np.array([41.61, 4.00, 12.52])
        self.cheapConstr = [True, True, True, True, True, True, True, True, True, True]
    ...
    def evaluate(self, x):
        ...
        return np.array([f1, f2, f3]), np.array(
