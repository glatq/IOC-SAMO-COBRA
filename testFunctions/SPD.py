...
class SPD:
    def __init__(self):
        self.lower = np.array([150, 25, 12, 8, 14, 0.63])
        self.upper = np.array([274.32, 32.31, 22, 11.71, 18, 0.75])
        self.nConstraints = 9
        self.nObj = 3
        self.ref = np.array([16, 19000, -260000])
        self.nadir = np.array([11.24, 12434.76, -292146.91])
        self.cheapConstr = [True, True, True, True, True, True, True, True, True]
    ...
    def evaluate(self, x):
        ...
        return np.array([transportationCost, lightShip, annualCargo]), np.array(
